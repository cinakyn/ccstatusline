...
import {
    advanceColorIndex,
    pickPowerlineColors
} from '../../utils/powerline-color-cycle';
    ...
    const lines = settings.lines.map((line) => {
        ...
        const groups = line.groups.map((group) => {
            ...
            const widgets = group.widgets.map((widget) => {
                ...
                const slot = pickPowerlineColors(themeColors, widgetColorIndex);
                const isGroupBoundaryFirst = !isFirstGroup && renderedInGroup === 0;
                renderedInGroup++;
                widgetColorIndex = advanceColorIndex(widgetColorIndex, widget, isGroupBoundaryFirst);
